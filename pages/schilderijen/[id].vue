  ...
  meta: [
    {
      ...
      content: painting.value
        ? `Bekijk "${painting.value.title}" door kunstenaar Tom van As. ${
            painting.value.categories?.length
              ? `Categorieën: ${painting.value.categories.join(", ")}.`
              : ""
          }`
